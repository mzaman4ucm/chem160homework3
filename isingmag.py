...
Temp=0.1             # Temperature when all spins spin up
...
for i in range(n):
    for j in range(n):
        totalspin = totalspin + spins[i][j]

    magnetization = totalspin/n2
    
print('%8.4f %10.6f %10.6f %10.6f'%(Temp, E_ave, Cv, magnetization))
